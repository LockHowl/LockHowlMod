...
public class Cravings extends CustomCard {

    public static final String ID = "Forethought";

    public static final String _ID = "LockHowl:Cravings";
    ...
    public Cravings() {
        super(ID, NAME, new RegionName("colorless/skill/forethought"), COST, DESC, TYPE, COLOR, RARITY, TARGET);
