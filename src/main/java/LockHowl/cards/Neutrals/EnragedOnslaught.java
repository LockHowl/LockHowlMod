...
import LockHowl.powers.EnragedPower;
...
public class EnragedOnslaught extends CustomCard {
    public static final String ID = "Mayhem";

    public static final String _ID = "LockHowl:Enraged";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new ApplyPowerAction(p, p, new EnragedPower(p, 1), 1));
    }
