...
public class Indecision extends AbstractDynamicCard implements WhenScriedUse {

    public static final String ID = "LockHowl:Indecision";
    public static final String IMG = makeCardPath("cIndecision.png");
